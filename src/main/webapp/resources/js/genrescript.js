...
$('.chtitle').click(function() {
  if ($(this).children('i').attr('class')=='expand-icon iconfont') {
    $(this).next('.chlist').show();
    $(this).children('i').attr('class','collapse-icon iconfont');
  } else {
    $(this).next('.chlist').hide();
    $(this).children('i').attr('class','expand-icon iconfont');
  }
});

//table detail box tab
$(function(){
    var $mangadetail =$(".detail-menu li");
