...
public class InvoiceDetailsSongsJpaArquillianUnitTest {  
    ...
    public static WebArchive deploy() {
        ...
        final WebArchive webArchive = ShrinkWrap.create(WebArchive.class, "test.war")
                ...
                .addPackage(InvoiceDetailsSongsJpaController.class.getPackage())
                .addPackage(RollbackFailureException.class.getPackage())
                .addPackage(InvoiceDetailsSongs.class.getPackage())
    ...
    @Inject
    private InvoiceDetailsSongsJpaController invoiceDetailsSongsController;
    
    @Resource(name= "java:app/TroubleMediaDataBase")
    private DataSource ds;    
    
    public InvoiceDetailsSongsJpaArquillianUnitTest(){}
    
    @Test
    public void testGetSalesByTrack() throws Exception {
        Date date1 = new SimpleDateFormat("yyyy-MM-dd").parse("2016-01-01");
        Date date2 = new Date();
        int trackId = 1;
        
        List<Object[]> trackSales = invoiceDetailsSongsController.getSalesByTrack(trackId, date1, date2);
        assertThat(trackSales.size()).isEqualTo(1);
    }
