...
public class InvoiceDetailsAlbumsJpaArquillianUnitTest {  
    ...
    public static WebArchive deploy() {
        ...
        final WebArchive webArchive = ShrinkWrap.create(WebArchive.class, "test.war")
                ...
                .addPackage(InvoiceDetailsAlbumJpaController.class.getPackage())
                .addPackage(RollbackFailureException.class.getPackage())
                .addPackage(InvoiceDetailsAlbum.class.getPackage())
    ...
    @Inject
    private InvoiceDetailsAlbumJpaController invoiceDetailsAlbumController;
    
    @Resource(name= "java:app/TroubleMediaDataBase")
    private DataSource ds;    
    
    public InvoiceDetailsAlbumsJpaArquillianUnitTest(){}
    
    @Test
    public void testGetSalesByAlbum() throws Exception {
        Date date1 = new SimpleDateFormat("yyyy-MM-dd").parse("2016-01-01");
        Date date2 = new Date();
        int albumId = 1;
        
        List<Object[]> albumSales = invoiceDetailsAlbumController.getSalesByAlbum(albumId, date1, date2);
        assertThat(albumSales.size()).isEqualTo(1);
    }
