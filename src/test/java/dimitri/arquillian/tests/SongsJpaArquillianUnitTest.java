...
public class SongsJpaArquillianUnitTest {  
    ...
    public SongsJpaArquillianUnitTest(){}
    
    @Test
    public void testGetTracksPurchased() throws Exception {
        int clientId = 1;
        List<Object[]> topClients = songsController.getTracksPurchased(clientId);
        assertThat(topClients.size()).isEqualTo(0);  
    }   
    
    @Test
    public void testGetAlbumsPurchased() throws Exception {
        int clientId = 1;
        List<Object[]> topClients = songsController.getAlbumsPurchased(clientId);
        assertThat(topClients.size()).isEqualTo(0);      
    }
