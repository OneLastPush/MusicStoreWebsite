...
public class UsersJpaArquillianUnitTest {  
    ...
    public UsersJpaArquillianUnitTest(){}
    
    @Test
    public void testGetTopClients() throws Exception {
        Date date1 = new SimpleDateFormat("yyyy-MM-dd").parse("2016-01-01");
        Date date2 = new Date();
        
        List<Object[]> topClients = usersController.getTopClients(date1, date2);
        assertThat(topClients.size()).isEqualTo(6);
    }   
    
    @Test
    public void testGetClientsWithoutPurchase() throws Exception {
        Date date1 = new SimpleDateFormat("yyyy-MM-dd").parse("2016-01-01");
        Date date2 = new Date();
        
        List<Object[]> topClients = usersController.getClientsWithoutPurchase(date1, date2);
        assertThat(topClients.size()).isEqualTo(14);
    }
