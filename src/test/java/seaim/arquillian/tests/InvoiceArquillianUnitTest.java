...
public class InvoiceArquillianUnitTest {
    @Deployment
    ...
    @Inject
    private InvoicesJpaController ijc;
    
    @Resource(name="java:app/TroubleMediaDataBase")
    private DataSource ds;
    
    public InvoiceArquillianUnitTest(){}
    
    @Test
    public void TestEditInvoice() throws Exception{
        Invoices oldInvoice = ijc.findInvoices(1);
        Invoices newInvoice = ijc.findInvoices(1);
        newInvoice.setRemoved(true);
        ijc.edit(newInvoice);
        assertThat(ijc.findInvoices(1).getRemoved()).isNotEqualTo(oldInvoice.getRemoved());
    }
