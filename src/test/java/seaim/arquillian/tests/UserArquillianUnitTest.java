...
public class UserArquillianUnitTest {
    @Deployment
    public static WebArchive deploy() {
        ...
        final WebArchive webArchive = ShrinkWrap.create(WebArchive.class, "test.war")
                ...
                .addPackage(UserBackingBean.class.getPackage())
    ...
    @Inject
    private UserBackingBean ubb;
    
    @Resource(name="java:app/TroubleMediaDataBase")
    private DataSource ds;
    
    public UserArquillianUnitTest(){}
    
    //Create user tested at MaxArquillianUnitTest
    
    @Test
    public void TestEditUser() throws Exception{
        Users oldUser = ujc.findUsers(1);
        Users newUser = ujc.findUsers(1);
        
        newUser.setCity("Toronto");
        ujc.edit(newUser);
        assertThat(ujc.findUsers(1).getCity()).isNotEqualTo(oldUser.getCity());
    }
    
    @Test
    public void TestTotalPurchases() throws Exception{
        BigDecimal totalPurchases = ubb.getTotalPurchases(1);
        assertThat(totalPurchases).isEqualTo(new BigDecimal("0.00"));
    }
