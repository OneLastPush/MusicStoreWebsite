...
public class ReviewArquillianUnitTest {
    @Deployment
    ...
    @Inject
    private ReviewsJpaController rjc;
    
    @Resource(name="java:app/TroubleMediaDataBase")
    private DataSource ds;
    
    public ReviewArquillianUnitTest(){}
    
    @Test
    public void TestEditReview() throws Exception{
        Reviews oldReview = rjc.findReviews(1);
        Reviews newReview = rjc.findReviews(1);
        newReview.setApprovalStatus(true);
        rjc.edit(newReview);
        assertThat(rjc.findReviews(1).getApprovalStatus()).isNotEqualTo(oldReview.getApprovalStatus());
    }
